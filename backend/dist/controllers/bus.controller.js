import { getBusById, getAllActiveBuses, updateBusLocation, updateBusStatus, assignDriverToBus, createBus } from '../services/bus.service.js';
...
export async function createNewBus(req, res) {
